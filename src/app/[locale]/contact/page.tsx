...
export function generateMetadata({ params: { locale } }: Props) {
  return {
    title: locale === 'ar' ? 'اتصل بنا | Bin Hindi' : 'Contact Us | Bin Hindi',
    description: locale === 'ar' ? 'تواصل مع فريق Bin Hindi' : 'Get in touch with the Bin Hindi team',
  };
}
...
const contactInfo = {
  ...
  email: { en: 'info@binhindi.sa', ar: 'info@binhindi.sa' },
